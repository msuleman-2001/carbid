            ...
            <div class="row align-items-center justify-content-between align-items-center">
                <div class="col-lg-6 col-xl-6">
                    <div class="banner-content cl-white">
                        ...
                        <a href="#0" class="custom-button yellow btn-large" data-aos="fade-down" data-aos-duration="1300">Get Started</a>
                    </div>
                </div>
    ...
    <div class="browse-slider-section mt--140">
        <div class="container">
            <div class="section-header-2 mb-4">
                <div class="left">
                    <h6 class="title cl-white cusbg cl-lg-black pl-0">Browse the highlights</h6>
                </div>
        ...
        <div class="container">
            <div class="m--15">
                <div class="auction-wrapper-5">
                    ...
                    <div class="auction-item-5 time" data-aos="fade-down" data-aos-duration="1200">
                        <div class="auction-inner">
                            <div class="upcoming-badge" title="Upcoming Auction">
                                <i class="flaticon-auction"></i>
                            </div>
                    ...
                    <div class="auction-item-5 time" data-aos="fade-down" data-aos-duration="1300">
                        <div class="auction-inner">
                            <div class="upcoming-badge" title="Upcoming Auction">
                                <i class="flaticon-auction"></i>
                            </div>
